...
argParser.add_argument("-divisionNb",type=int,default=1, metavar='', help="The inverse of the fraction of the generation task this process should take on. Useful for running multiple concurrent generation tasks")
...
argParser.add_argument("-distinctDistbPerFormula", metavar='', type=int,default=4,help=" Number of Distinct Distributions per formula")
argParser.add_argument("-nodesPerBatch", type=int,  metavar='', default=2500,help="Number of Nodes (conjunction and literal) to have per batch")
...
# Prepare the proportions
dFS = {50: 30000, 100: 20000, 250: 16000, 500: 12000, 750: 10000, 1000: 8000, 2500: 6000, 5000: 3000}
...
DNFGen.createTrainingData(distinctFormulaSizes = dFSdiv,numClauseDistribution=nCD,clauseWidthDistribution=cWD,
                        ...
                        fileName = fileName, saveDestination = saveDest, logSaveDestination=logSaveDest,
